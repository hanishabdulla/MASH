...
def detect_text(frame, keywords):
    """Detects text in the file and checks for specified keywords."""
...
# Provide the dictionary of keywords and their corresponding values
...
def capture_and_process(frame):
    ...
    threading.Thread(target=detect_text, args=(frame,keywords)).start()

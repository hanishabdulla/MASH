...
def process_image(image_path, keywords):
    ...
    #print(f"Extracted Text for {image_path}:")
...
# Example image paths
image_paths = ['Photo 4427.JPEG']  # Add more paths as needed

# Process images concurrently
with concurrent.futures.ThreadPoolExecutor() as executor:
    futures = [executor.submit(process_image, image_path, keywords) for image_path in image_paths]

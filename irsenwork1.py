...
serialInst.port = '/dev/tty.usbmodem1401'
serialInst.open()

text_detected = False  # Flag to indicate if text has been detected
...
def process_image(image):
    ...
    if text_detected:
        return  # Skip processing if text has already been detected
        ...
        for text in texts:
            for keyword, value in keywords.items():
                if keyword in text.description:
                    ...
                    text_detected = True  # Set the flag to True
                    return
...
def main():
    ...
    while True:
        ...
        if serialInst.in_waiting:
            ...
            if "OMG" in packet_str and not text_detected:
        ...
        if text_detected:
            print("Text detected. Stopping further image processing.")
            # You can add any additional logic here for what to do after text is detected
